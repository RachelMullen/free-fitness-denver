...
export default function OrganizationDetail({deleteOrganization}) {
  ...
  const {id, name, attachment, description, announcements, link,social_media, events} = organization 
  ...
  return (
      ...
      <button><Link to={`/organizations/${id}/edit`}>Edit Organization</Link></button>
