...
export default function EventDetail({deleteEvent}) {
  ...
  const {id, name, attachment, description, announcements, date, time, link,social_media, location_name, address, city, state, zip, difficulty_distance, category, organizations} = event
